...
const Anecdote = ({ anecdote }) => (
  ...
  // const AnecdoteListWrapped = (props) => {
  ...
  //       <h2>Anecdotes</h2>
  //       <ul>
  //         {props.anecdotes.map(anecdote => <li key={anecdote.id} onClick={handleClick(anecdote.id)}>{anecdote.content}</li>)}
  //       </ul>
  //     </div>
  //     )
  //   }    
  //   const AnecdoteList1 = withRouter(AnecdoteListWrapped)
    ...
    const AnecdoteList = (props) => {
        ...
        <div>
          ...
          <ul>
            {props.anecdotes
              .map(anecdote => <li key={anecdote.id}>
...
return (
  ...
  const CreateNew = withRouter(CreateNewWrapped)
const App = (props) => {
...
const AnecdoteById = (id) => {
  ...
  console.log('id', id, 'anecdote', anecdote)
  return anecdote
}
